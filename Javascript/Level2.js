var Level2 = {
  ...
  preload: function() {
    ...
    //boss
    game.load.image('boss', 'assets/enemies/2ndboss.png');
    ...
    game.load.spritesheet('vortexbullet', '/assets/vortex.png', 100, 100);
    game.load.spritesheet('gate', '/assets/gate.png', 100, 100, 61);
  ...
  create: function() {
    ...
    //  The scrolling bluesky background
    bluesky = game.add.tileSprite(0, 0, 800, 600, 'bluesky');
    //  Our bullet group
    ...
    plasmabullets.createMultiple(30, 'vortexbullet');
    ...
    boss.finishOff = function() {
      if (!boss.dying) {
        ...
        game.time.events.add(1000, function() {
          ...
          boss.dying = false;
          bossDeath.on = false;
          gate = game.add.sprite(game.width - 80, 200, 'gate');
          var opengate = gate.animations.add('opengate');
          gate.animations.play('opengate', 30, true);
